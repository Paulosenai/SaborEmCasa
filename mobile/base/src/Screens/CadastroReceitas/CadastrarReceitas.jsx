...
export default function CadastrarReceitas({ navigation, route }) {
  const [nome, setNome] = useState(''); // armazena o nome da receita
  const [ingredientes, setIngredientes] = useState(''); // armazena os igredientes da receita
  const [modoPreparo, setModoPreparo] = useState(''); // armazena o modo de preparo 
  const [imagem, setImagem] = useState(null); // armazenar a imagem da receita
  const [value, setValue] = useState(''); // armazenar o valor da categoria da receita 
  const [status, setStatus] = useState(''); // armazenar o status da receita se e publico ou privado
